function [allData, scenario, sensors] = scenario4()
%scenario4 - Returns sensor detections
%    allData = scenario4 returns sensor detections in a structure
%    with time for an internally defined scenario and sensor suite.
%
%    [allData, scenario, sensors] = scenario4 optionally returns
%    the drivingScenario and detection generator objects.

% Generated by MATLAB(R) 9.13 (R2022b) and Automated Driving Toolbox 3.6 (R2022b).
% Generated on: 04-Dec-2022 15:21:53
...
vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [6.80000000000001 -30.77 0.01], ...
    'Yaw', -55, ...
    'Mesh', driving.scenario.carMesh, ...
    'Name', 'Car3');
